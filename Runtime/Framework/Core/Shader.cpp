...
bool Shader::CompileShader()
{
	...
	CREATESHADER(vsHandle, _vs, SHADER_VERTEX)
	CREATESHADER(fsHandle, _fs, SHADER_FRAGMENT)
	CREATESHADER(tesHandle, _tes, SHADER_TES)
	CREATESHADER(tcsHandle, _tcs, SHADER_TCS)
	CREATESHADER(gsHandle, _gs, SHADER_GEOMETRY)
	CREATESHADER(csHandle, _cs, SHADER_COMPUTE)
