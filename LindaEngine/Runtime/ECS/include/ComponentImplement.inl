...
#define DYNAMIC_CREATE(CLASS_NAME) \
    Ref<LindaEngine::Component> CLASS_NAME::CreateComponent(LindaEngine::Entity& entity, bool enable) \
    { \
    ...
    static int g_tmp_##CLASS_NAME = \
        LindaEngine::ComponentFactory::RegisterObj(#CLASS_NAME, CLASS_NAME::CreateComponent);
